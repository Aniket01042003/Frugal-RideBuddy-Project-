  ...
  const handleSubmit = (e) => {
      ...
      .then((res) => {
        if (res.success) {
          ...
          toast.error(res.message || "Check Credentials");
        }
      })
      .catch(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          ...
          <div className="mt-12 flex flex-col items-center">
            <div className="w-full flex-1 mt-8">
              <Link to={`${API_BASE_URL}/auth/google`} className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-[#6a297b] text-[white] flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:bg-[#470158] transition-all duration-300 ease-in-out focus:shadow-sm focus:shadow-outline">
                    ...
                    <span className="ml-4">Register with Google
                    </span>
                  </button>
              ...
              <form onSubmit={handleSubmit} >
                <div className="mx-auto max-w-xl">
                  <input className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="name" name='name' required placeholder="Name" />
                  ...
                  <input className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="number" name='phone' required placeholder="Phone" />
        ...
        <div className="flex-1 bg-[#D9D9D9] text-center hidden lg:flex">
