            ...
            <div className="w-full flex-1 mt-8">
              <Link to={`${API_BASE_URL}/auth/google`} className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  <button className="w-full max-w-xs font-bold cursor-pointer  shadow-sm rounded-lg py-3 bg-[#6a297b] text-[white] flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:bg-[#470158] transition-all duration-300 ease-in-out focus:shadow-sm focus:shadow-outline">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mx-auto max-w-xl">
                  ...
                  <button type='submit' className="mt-5 tracking-wide cursor-pointer  font-semibold bg-[#6b0a83] text-white w-full py-4 rounded-lg hover:bg-[#470158] transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
